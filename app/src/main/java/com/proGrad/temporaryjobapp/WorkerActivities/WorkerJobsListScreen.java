...
public class WorkerJobsListScreen extends AppCompatActivity {
    private ListView lv;
    private ArrayList<HashMap<String, Integer>> jobs = new ArrayList<>();
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_worker_jobs_list_screen);
        lv = (ListView) findViewById(R.id.Job_user_show_lv);
        ...
        params.put("salary", "0" + getIntent().getStringExtra("salary"));
        params.put("category", getIntent().getStringExtra("category"));
        params.put("location", loc);
        TempJobsRestClientUsage.post("searchJob.php", params, new AsyncHttpResponseHandler()
        {
            @Override
                ...
                try
                {
                    ...
                    if (resObj.getBoolean("success"))
                    {
                        ...
                        ArrayAdapter<String> arrayAdapter = new ArrayAdapter<String>(
                                com.proGrad.temporaryjobapp.WorkerActivities.WorkerJobsListScreen.this,
        ...
        lv.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                Intent intent = new Intent(com.proGrad.temporaryjobapp.WorkerActivities.WorkerJobsListScreen.this , WorkerJobInfo.class);
