...
public class OwnerProfileInfoScreen extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_owner_profile_info_screen);
        mEmailET    = (EditText) findViewById(R.id.admin_email_profile_edit_et) ;
        mUsernameET = (EditText) findViewById(R.id.admin_username_profile_edit_et) ;
        mPasswordET = (EditText) findViewById(R.id.admin_password_profile_edit_et) ;
        mPhoneET    = (EditText) findViewById(R.id.admin_phone_number_profile_edit_et) ;
        mFullnameET = (EditText) findViewById(R.id.admin_fullname_profile_edit_et) ;
        ...
        saveChangesButton = findViewById(R.id.admin_save_changes_edit_profile_bt);
            ...
            public void onSuccess(int statusCode, Header[] headers, byte[] responseBody)
            {
                try
                {
                    ...
                    if (resObj.getBoolean("success"))
                    {
                        ...
                        StyleableToast.makeText(OwnerProfileInfoScreen.this,
