...
public class ModifyJobScreen extends AppCompatActivity {
    ...
    private AutoCompleteTextView mWorkerAC;
    private Button modifyJobButton;
    private ArrayList<HashMap<String, Integer>> cates = new ArrayList<>();
    private ArrayList<HashMap<String, Integer>> workers = new ArrayList<>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_modify_job_screen);
        ...
        mWorkerAC           = (AutoCompleteTextView) findViewById(R.id.job_worker_et);
        mJobLocationTV.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent mIntent = new Intent(com.proGrad.temporaryjobapp.OwnerActivities.ModifyJobScreen.this, Map.class);
        ...
        mDeadLineTV.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                DatePickerDialog datePickerDialog = new DatePickerDialog(com.proGrad.temporaryjobapp.OwnerActivities.ModifyJobScreen.this,
        ...
        modifyJobButton= findViewById(R.id.modify_job_bt);
                ...
                try
                {
                    ...
                    if (resObj.getBoolean("success"))
                    {
                        ...
                        ArrayAdapter<String> adapter = new ArrayAdapter<String>
                                (com.proGrad.temporaryjobapp.OwnerActivities.ModifyJobScreen.this, android.R.layout.simple_list_item_1, cs);
        ...
        TempJobsRestClientUsage.get("getWorkers.php", null, new AsyncHttpResponseHandler() {
            @Override
            public void onSuccess(int statusCode, Header[] headers, byte[] responseBody)
            {
                try
                {
                    ...
                    if (resObj.getBoolean("success"))
                    {
                        ...
                        for (int i = 0, len = jsonArray.length(); i < len; i++)
                        {
                            ...
                            HashMap<String, Integer> hashMap = new HashMap<>();
                            hashMap.put(category.getString("worker_email"),
                                    category.getInt("id"));

                            cs[i] = category.getString("worker_email");
                        ...
                        ArrayAdapter<String> adapter = new ArrayAdapter<String>
                                (com.proGrad.temporaryjobapp.OwnerActivities.ModifyJobScreen.this, android.R.layout.simple_list_item_1, cs);
                        mWorkerAC.setThreshold(1);
                        mWorkerAC.setAdapter(adapter);
                    }
                    else
                    {
                        Toast.makeText(getApplicationContext(), resObj.getString("message"),
        ...
        TempJobsRestClientUsage.post("getJobDetails.php", requestParams, new AsyncHttpResponseHandler() {
            ...
            public void onSuccess(int statusCode, Header[] headers, byte[] responseBody) {
                try
                {
                    ...
                    if (resObj.getBoolean("success"))
                    {
                        mJobNameET.setText(resObj.getString("job_name"));
                        mJobLocationTV.setText(resObj.getString("job_location"));
                        mJobSalaryET.setText(resObj.getString("job_salary"));
                        mJobDescriptionET.setText(resObj.getString("job_description"));
                        mDeadLineTV.setText(resObj.getString("job_deadline"));
                        mJobCategoryAC.setText(resObj.getString("category_name"));
                    }
                    else
                    {
                        Toast.makeText(getApplicationContext(), resObj.getString("message"),
    ...
    public void attempEditJob()
    {
        ...
        requestParams.put("job_category_id", mCategoryId + "");
        ...
        requestParams.put("worker_id", checkWorker() + "");
        requestParams.put("owner_id", SessionManager.getInstance(getApplicationContext()).getUserID() + "");

        TempJobsRestClientUsage.post("editJob.php", requestParams, new AsyncHttpResponseHandler() {
            @Override
            public void onSuccess(int statusCode, Header[] headers, byte[] responseBody)
            {
                try
                {
                    ...
                    if (resObj.getBoolean("success"))
                    {
                        StyleableToast.makeText(com.proGrad.temporaryjobapp.OwnerActivities.ModifyJobScreen.this,
                                " Job Modified", Toast.LENGTH_LONG, R.style.MyToast).show();
    ...
    private int checkWorker()
    {
        int res = 0;

        for (int i = 0, len = workers.size(); i < len; i++)
        {
            HashMap<String, Integer> c = workers.get(i);

            if (c.containsKey(mWorkerAC.getText().toString()))
            {
                res = c.get(mWorkerAC.getText().toString());
                break;
            }
        }
